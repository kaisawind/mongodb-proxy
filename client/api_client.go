...
import (
	...
	"github.com/kaisawind/mongodb-proxy/client/simple_json"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *API {
	...
	cli.SimpleJSON = simple_json.New(transport, formats)
	return cli
}
...
type API struct {
	SimpleJSON simple_json.ClientService
...
func (c *API) SetTransport(transport runtime.ClientTransport) {
	...
	c.SimpleJSON.SetTransport(transport)
}
