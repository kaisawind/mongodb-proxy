...
//go:generate swagger generate server --target ../../mongodb-proxy --name API --spec ../swagger/swagger.yaml --model-package v1 --principal v1.Principal
...
func setupGlobalMiddleware(handler http.Handler) http.Handler {
	return mws.LogViaLogrus(mws.Cross(handler))
}
